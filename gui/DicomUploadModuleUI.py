...
class DicomUploadModuleUI(object):
    ...
    def setupUi(self, module):
        ...
        self.centralwidget.setObjectName(_fromUtf8("dicomUploadModule"))
...
####  ######  #######  ##    ##
    ...
    def retranslateUi(self, Module):
        """
        """
        self.btnUpload.setText(QtGui.QApplication.translate("MainWindow", "Upload DICOM data", None, QtGui.QApplication.UnicodeUTF8))